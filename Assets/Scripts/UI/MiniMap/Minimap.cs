...
public class Minimap : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
{
    ...
    void Update()
    {
        ...
        {
            Vector2 uiPos = new Vector2(Mathf.Clamp(Input.mousePosition.x, 35f, 280f), Mathf.Clamp(Input.mousePosition.y, 20f, 260f)) / GameManager.instance.canvasScaleFactor - _offset;
